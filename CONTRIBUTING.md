...
Printernizer uses a **feature branch model**:
...
```
Your fork → feature/your-feature → master (PR)
```
...
```bash
# Ensure you have the latest master branch
git checkout master
...
Create a pull request on GitHub **targeting the `master` branch** with:
