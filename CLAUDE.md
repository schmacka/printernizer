...
**IMPORTANT**: Always create feature branches from `master`. See [RELEASE.md](RELEASE.md) and [CONTRIBUTING.md](CONTRIBUTING.md) for complete workflow.
...
Run Printernizer in a Docker container:
